...
int main() {
    ...
    cin >> choice;   
    switch (choice) {
        case 1: fifoPageReplacement(pages, capacity);
                break;
        case 2: optimalPageReplacement(pages, capacity);
                break;
        case 3: lruPageReplacement(pages, capacity);
                break;
        case 4: mruPageReplacement(pages, capacity);
                break;
